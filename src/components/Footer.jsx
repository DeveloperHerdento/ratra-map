...
export function Footer() {
  return (
    <footer className="border-t border-border">
      <div className="mx-auto grid max-w-[88rem] gap-12 px-6 py-16 md:grid-cols-3 lg:px-10">
        <div>
          <div className="flex items-baseline gap-2">
            <span className="font-display text-lg font-semibold">RATRA</span>
            <span className="label-mono">maps</span>
          </div>
